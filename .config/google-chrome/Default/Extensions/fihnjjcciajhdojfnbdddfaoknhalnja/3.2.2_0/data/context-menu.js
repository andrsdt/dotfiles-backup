...
function doTheMagic(tabId, frameId, anotherTry)
{
	...
	// Common CSS rules
	chrome.tabs.insertCSS(tabId, {file: "data/css/common.css", frameId: frameId || 0, runAt: 'document_start'}, function() {
		...
		chrome.tabs.executeScript(tabId, {file:'data/js/embeds.js', frameId: frameId || 0, runAt: 'document_end'}, function() {});
		...
		chrome.tabs.executeScript(tabId, {file:'data/js/common.js', frameId: frameId || 0, runAt: 'document_end'}, function() {});
	});
}
